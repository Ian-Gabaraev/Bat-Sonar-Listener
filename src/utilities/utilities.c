...
void help() {
  ...
  printf(
      "Captures ultrasonic data from compatible microphones (e.g., Pettersson "
      "U256)\n");
  printf(
      "and performs live frequency analysis and telemetry relay via MQTT.\n\n");
  ...
  printf(
      "  \033[1;32m--help, -h\033[0m               Show this help message and "
      "exit\n");
  printf(
      "  \033[1;32m--config <file>\033[0m          Path to JSON configuration "
      "file\n");
  printf(
      "  \033[1;32m--device <id>\033[0m            Specify audio device ID "
      "(default: auto)\n");
  printf(
      "  \033[1;32m--buffer <size>\033[0m          Set audio buffer size in "
      "samples\n");
  printf(
      "  \033[1;32m--mqtt\033[0m                   Enable MQTT telemetry "
      "output\n");
  printf(
      "  \033[1;32m--gui\033[0m                    Enable Raylib-based "
      "visualization window\n");
  printf(
      "  \033[1;32m--outfile <file>\033[0m         Save recorded samples to "
      "WAV file\n");
  printf(
      "  \033[1;32m--verbose\033[0m                Print detailed runtime "
      "logs\n\n");
  ...
  printf(
      "  The Bat Sonar Listener continuously samples ultrasonic frequencies up "
      "to\n");
  printf(
      "  256 kHz and performs fast signal analysis (RMS, dominant frequency, "
      "etc.).\n");
  printf(
      "  Data can be relayed to remote systems for visualization, storage, or "
      "cloud\n");
  printf(
      "  processing. Ideal for bioacoustics research and field monitoring "
      "setups.\n\n");
